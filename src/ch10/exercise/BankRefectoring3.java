...
//		ArrayList<Account> accounts = new ArrayList<>();
	...
	private static void depositAccounts(Scanner in, List<Account> accounts) {
		Long y;
	...
	private static void withrawAccount(Scanner in, List<Account> accounts) {
		Long money;
